...
function Login() {
    ...
    const {register, HandleSubmit} = useForm() // register -> automatically picks the input values and and when HandleSubmit is called then values are taken automatically => state handling for values done automatically
